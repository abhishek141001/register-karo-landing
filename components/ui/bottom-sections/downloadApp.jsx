export default function DownloadApp() {
    return (
        <div className="p-4 md:p-10 xl:p-20 bg-[#1C4670] flex flex-col xl:flex-row text-white  relative overflow-hidden">
            <div className="flex flex-col gap-8 w-[80%] lg:w-[40%]">
